...
1. Download the [latest release bundle](https://github.com/GoogleCloudPlatform/recaptcha-enterprise-google-tag-manager/releases/latest). And extract the contents.
